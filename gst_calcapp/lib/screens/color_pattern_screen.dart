...
class _ColorPatternScreenState extends State<ColorPatternScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          Expanded(child: Container(color: colors[(i)%4],),),
          Expanded(child: Container(color: colors[(i+1)%4],)),
          Expanded(child: Container(color: colors[(i+2)%4],)),
          Expanded(child: Container(color: colors[(i+3)%4],)),
